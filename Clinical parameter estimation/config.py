...
def parse_args():
    ...
    parser.add_argument("--data_path_MIPs_collages_512_512", default="/media/sambit/HDD/Sambit/Projects/Project_5/GitHub/Tumor-segmentation-from-PET-CT-followed-by-outcome-prediction/Clinical parameter estimation/Data_Pre-processing/Output/MIPs_collages_512_512", help="Path containing multi-channel PET/CT collages of coronal and sagittal projections for all the patients.")
    ...
    parser.add_argument("--path_df_rot_mips", default="/media/sambit/HDD/Sambit/Projects/Project_5/GitHub/Tumor-segmentation-from-PET-CT-followed-by-outcome-prediction/Clinical parameter estimation/Data_Pre-processing/Output/df_rot_mips.csv", help="DataFrame with rotating mips path.")
    ...
    parser.add_argument("--rotation_min", default=-90, help="Minimum angle by which the MIP will be rotated.")
    ...
    parser.add_argument("--path_CV_Output", default="/media/sambit/HDD/Sambit/Projects/Project_5/GitHub/Tumor-segmentation-from-PET-CT-followed-by-outcome-prediction/Clinical parameter estimation/Cross_Validation/Output/Regression/Age", help="Cross Validation Output.")
    ...
    parser.add_argument("--in_channels", default=10, help="Total number of input channels.")
    ...
    parser.add_argument("--dropout", default=0.25, help="Dropout Percentage.")
    ...
    #Training Parameters
    parser.add_argument("--max_epochs", default=500, help="Maximum Number of Epochs for Training.")
    ...
    parser.add_argument("--best_metric_regression", default=10000000000, help="Best Dice Metric.")
