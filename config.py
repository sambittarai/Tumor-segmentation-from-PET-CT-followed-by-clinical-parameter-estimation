...
def parse_args():
    ...
    parser.add_argument("--output_path", default="/media/sambit/HDD/Sambit/Projects/Project_5/GitHub/Tumor-segmentation-from-PET-CT-followed-by-outcome-prediction/Data Preparation/Output", help="Path containing all the Patient's Data.")
    ...
    parser.add_argument("--SUV_max_collage", default=14, help="Maximum SUV to be used during generation of collages for the purpose of visualization")
